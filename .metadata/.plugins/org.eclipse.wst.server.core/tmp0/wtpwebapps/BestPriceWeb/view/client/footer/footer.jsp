							...
							<div class="col-md-4 col-sm-6">
								<div class="aa-footer-widget">
									<a href="${pageContext.request.contextPath}/"><img
										src="${url}/images/logo.png" alt="logo img" style="width: 65%;height: 30%"
										></a>
									<ul class="aa-footer-nav">

										<li><p
												style="color: #888; text-align: justify; width: 95%">Best
												Price là trang bán hàng hàng đầu Việt Nam. Chúng tôi mong
												muốn đem đến những giá trị tích cực nhất cho khách hàng.
												Tiêu chí của chúng tôi là hàng tốt - giá tốt. Vì một Việt
												Nam thịnh vượng!</p></li>
										<li><img
							...
							<div class="col-md-4 col-sm-6">
								<div class="aa-footer-widget">
									<div class="aa-footer-widget">
										<h3>LIÊN HỆ</h3>
										<address>
											<p>Số 10 - Tòa nhà Ocean City - Hai Bà Trưng - Hà Nội</p>
											<p>
												<span class="fa fa-phone"></span>1900 1900
											</p>
											<p>
												<span class="fa fa-envelope"></span>hoangnguyenhtng@gmail.com
											</p>
										</address>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="aa-footer-bottom-area">
						<p>Copyright 2023 &copy Best Price</p>
