				...
				<div class="aa-header-bottom-area">
                  ...
                  <p>daily<strong>Shop</strong> <span>Your Shopping Partner</span></p>
						...
						<a href="${pageContext.request.contextPath}/"><img
							src="${url}/images/logo.png" alt="logo img" width="100%"></a>
					</div>
					<!-- / logo  -->
					<!-- Shipping service -->
					<div class="aa-shipping-box">
						<a class="aa-shipping-boxsmall"> <span
							...
							class="aa-shipping-box-text">
								...
								<div class="">Khu vực Hà Nội, TP.HCM</div>
						</span>

						</a> <a class="aa-shipping-boxsmall"> <span
							class="aa-shipping-boxsmall-icon fas fa-phone"></span> <span
							class="aa-shipping-box-text">
								<div class="aa-shipping-title">Hỗ trợ: 19001900</div>
								<div class="">Hỗ trợ 24/7</div>
						</span>
							...
							class="aa-shipping-box-text">
								...
								<div class="">Đảm bảo uy tín từ các thương hiệu hàng đầu</div>
						</span>
