...
<section id="aa-catg-head-banner">
	<img
		src="${pageContext.request.contextPath}/view/client/assets/images/blog-banner.png"
		alt="banner blog">
											...
											<c:forEach items="${boardnewlist}" var="boardnew" end="2">
												<li><a class="aa-cartbox-img"
													...
													<div class="aa-cartbox-info">
														<h4>
															<a
																href="${pageContext.request.contextPath}/view/client/news-list-detail?id=${boardnew.id}"><b>${boardnew.title }</b></a>
														</h4>
