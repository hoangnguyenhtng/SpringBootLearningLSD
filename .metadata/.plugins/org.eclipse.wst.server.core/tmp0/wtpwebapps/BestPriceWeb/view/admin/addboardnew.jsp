				...
				<div class="card">
					<div class="card-body">
						...
						<form action="${pageContext.request.contextPath}/admin/new/add"
							...
							<div class="form-group">
								<label for="input-3">Hình ảnh</label> <input type="text"
									class="form-control" id="input-18"
									placeholder="Địa chỉ hình ảnh" name="new-image_link">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="input-5">Ngày đăng</label> <input type="date"
									class="form-control" id="the-date" name="new-created">
							</div>
							<div class="form-footer">

								<button class="btn btn-danger">
									<i class="fa fa-times"></i><a
										href="${pageContext.request.contextPath}/admin/new/list">Hủy</a>
								</button>
